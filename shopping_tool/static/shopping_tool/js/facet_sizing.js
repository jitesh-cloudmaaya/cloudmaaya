...
var facet_sizing = {
  ...
  */  
  petite_sizes: ['00P','0P','2P','4P','6P','8P','10P','12P','14P','16P','18P','20P','22P','24P'],
  /**
  ...
  */
    ...
    '18P':{
      members: [{size:'18P',name: '18P'},{size:'PETITE XX-LARGE',name: 'PETITE XX-LARGE'}],
      sizes: ['18P','PETITE XX-LARGE']
    },
    '20P':{
      members: [{size:'20P',name: '20P'},{size:'PETITE XX-LARGE',name: 'PETITE XX-LARGE'}],
      sizes: ['20P','PETITE XX-LARGE']
    },
    '22P':{
      members: [{size:'22P',name: '22P'},{size:'PETITE XXX-LARGE',name: 'PETITE XXX-LARGE'}],
      sizes: ['22P','PETITE XXX-LARGE']
    },
    '24P':{
      members: [{size:'24P',name: '24P'},{size:'PETITE XXX-LARGE',name: 'PETITE XXX-LARGE'}],
      sizes: ['24P','PETITE XXX-LARGE']
    },                    
    '18':{
    ...
    '00T':{
      members: [{size:'TALL X-SMALL',name: 'TALL X-SMALL'}],
      sizes: ['TALL X-SMALL']
    },      
    '0T':{
      members: [{size:'TALL X-SMALL',name: 'TALL X-SMALL'}],
    ...
    '2T':{
      members: [{size:'TALL SMALL',name: 'TALL SMALL'}],
      sizes: ['TALL SMALL']
    },      
    '4T':{
      members: [{size:'TALL SMALL',name: 'TALL SMALL'}],
    ...
    '8T':{
      members: [{size:'TALL MEDIUM',name: 'TALL MEDIUM'}],
      sizes: ['TALL MEDIUM']
    },      
    '10T':{
      members: [{size:'TALL MEDIUM',name: 'TALL MEDIUM'}],
    ...
    '12T':{
      members: [{size:'TALL LARGE',name: 'TALL LARGE'}],
      sizes: ['TALL LARGE']
    },      
    '14T':{
      members: [{size:'TALL LARGE',name: 'TALL LARGE'}],
    ...
    '16T':{
      members: [{size:'TALL X-LARGE',name: 'TALL X-LARGE'}],
      sizes: ['TALL X-LARGE']
    },  
    '18T':{
      members: [{size:'TALL XX-LARGE',name: 'TALL XX-LARGE'}],
      sizes: ['TALL XX-LARGE']
    },
    '20T':{
      members: [{size:'TALL XX-LARGE',name: 'TALL XX-LARGE'}],
    ...
    '22T':{
      members: [{size:'TALL XXX-LARGE',name: 'TALL XXX-LARGE'}],
      sizes: ['TALL XXX-LARGE']
    },
    '24T':{
      members: [{size:'TALL XXX-LARGE',name: 'TALL XXX-LARGE'}],
      sizes: ['TALL XXX-LARGE']
