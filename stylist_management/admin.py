...
class StylistProfileAdmin(admin.ModelAdmin):
    ...
    def has_delete_permission(self, request, obj=None): # disable the add button
        return False
    ...
    list_display = ('stylist_id', 'stylist', 'email', 'phone', 'director', 'manager', 'asm', 'role', 'on_duty', 'on_board', 'client_tier', 'start_date', 'off_board_date', 'pay_rate', 'birthday', 'date_created', 'last_updated')
