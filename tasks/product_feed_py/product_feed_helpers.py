...
def send_email():
    ...
    fromaddr = ALERT_EMAIL_ADDRESS
    toaddr = ALERT_EMAIL_ADDRESS # this part is a placeholder
    msg = MIMEMultipart()
    msg['From'] = fromaddr
    msg['To'] = toaddr
    msg['Subject'] = 'Placeholder (TBD)'
    ...
    server.starttls()
    server.login(fromaddr, ALERT_EMAIL_PASSWORD)
    text = msg.as_string()
